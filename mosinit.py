'''
Current clamp demo using Allen Brain's model 472424854.
...
from neuron472424854 import Neuron472424854
...
def demo(iapp):
    ...
    h.celsius = 34.0
    cell = Neuron472424854(name='neuron')
    ...
    vbox.intercept(0)
    vbox.map('Allen Institute model 472424854; v includes junction potential', 10, 10, 600, 400)

    # procedure for doing and plotting each simulation
    def do_current_clamp_experiment(amp, color):   
        ic.amp = amp / 1000.
        
        h.finitialize(-93.3939743042)
        h.fcurrent()
